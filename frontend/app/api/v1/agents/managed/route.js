...
export async function POST(request) {
  ...
  try {
    await verifyOwnerAuthorization({ rpcUrl, challengeToken: body.challengeToken, signature: body.signature, owner: getAddress(body.owner), account: getAddress(body.account), action: "list-agents", params: {} });
