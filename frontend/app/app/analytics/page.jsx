  ...
  return (
    <div className="page-stack">
      ...
      <style jsx global>{`
        ...
        .analytics-market{padding:17px;border:1px solid #2c2c2c;border-radius:14px;background:#101010}
        .analytics-market-main{display:flex;justify-content:space-between;align-items:center;gap:16px}
        .analytics-asset{display:flex;align-items:center;gap:12px}.analytics-asset .token{display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border-radius:50%;background:#171717;color:#d7d7d2;font-weight:800}.analytics-asset strong,.analytics-asset small{display:block}.analytics-asset small{margin-top:4px;color:#8d8d88;font-size:11px}.analytics-market-status{font-size:11px;color:#8d8d88}.analytics-market-numbers{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:12px;margin-top:16px}.analytics-market-numbers span,.analytics-util-head span,.risk-card span{display:block;color:#8d8d88;font-size:11px}.analytics-market-numbers strong{display:block;margin-top:5px;font-size:13px;font-variant-numeric:tabular-nums}.analytics-util{margin-top:15px}.analytics-util-head{display:flex;justify-content:space-between;gap:12px}.analytics-util-head strong{font-size:11px}.analytics-util-track{height:5px;margin-top:9px;border-radius:999px;background:#242424;overflow:hidden}.analytics-util-fill{height:100%;border-radius:999px;background:#777772}.risk-list{display:grid;gap:12px}.risk-card{padding:15px;border:1px solid #2c2c2c;border-radius:14px;background:#101010}.risk-card-head{display:flex;justify-content:space-between;align-items:center;margin-bottom:10px}.risk-card-head strong{font-size:13px}.risk-card-head span{color:#8d8d88;font-size:10px}.risk-card>div:not(.risk-card-head){display:flex;justify-content:space-between;gap:16px;padding:8px 0;border-top:1px solid #2c2c2c}.risk-card>div:not(.risk-card-head) strong{font-size:12px}.analytics-note{padding:16px}.analytics-note p{margin:7px 0 0;color:#8d8d88;font-size:11px;line-height:1.6}
