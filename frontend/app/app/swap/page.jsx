  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(async () => {
      try {
        ...
        if (!response.ok || !result.success) throw new Error(result.error || 'Centry could not find a route.');
